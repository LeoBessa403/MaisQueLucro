...
$(window).on('load', function () {
    ...
    var gradientred1 = areachartblue.createLinearGradient(0, 0, 0, 135);
    ...
    var myareachartblue = {
        type: 'line',
        data: {
            labels: ['Jan-15', 'Jan-30', 'Feb-15', 'Feb-30', 'Mar-15', 'Mar-30', 'Apr-15', 'Apr-30', 'May-15', 'May-30', 'Jun-15'],
            datasets: [{
                label: '# income',
                data: [
                    randomScalingFactor(),
