...
/**
 * CategoriaFcFilha.Entidade [ ENTIDADE ]
 * @copyright (c) 2022, Leo Bessa
 */

class CategoriaFcFilhaEntidade extends AbstractEntidade
{
	const TABELA = 'TB_CATEGORIA_FC_FILHA';
	const ENTIDADE = 'CategoriaFcFilhaEntidade';
	const CHAVE = CO_CATEGORIA_FC_FILHA;
    ...
    */
	...
	/**
	* @return int $co_categoria_fc_filha
    */
