...
<div class="container">
    <div class="row">
        ...
        <div class="col-6 col-md-3 col-lg-3 col-xxl-2">
                    ...
                    <div class="swiper-container creditcards">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="card border-0 mb-3 theme-blue bg-radial-gradient">
                                    <div class="card-body">
                            ...
                            <div class="swiper-slide">
                                <div class="card border-0 theme-green bg-radial-gradient mb-3">
                                    <div class="card-body">
                                        <div class="row align-items-center mb-4">
                                            <div class="col-auto align-self-center">
                                                <img src="assets/img/visa.png" alt="">
                                ...
                                <div class="row amount-data">
                                    <div class="col">
                                        <p class="text-secondary small mb-1">Expense</p>
                                        <p>3650.00 <small class="text-danger">11.0% <i
                                                        class="bi bi-arrow-down"></i></small></p>
                                    </div>
                                    <div class="col-auto text-end">
                                        <p class="text-secondary small mb-1">Limit Remain</p>
                                        <p>35500.00</p>
                            ...
                            <div class="swiper-slide">
                                <div class="card border-0 theme-purple bg-radial-gradient mb-3">
                                    <div class="card-body">
                                        <div class="row align-items-center mb-4">
                                            <div class="col-auto align-self-center">
                                                <img src="assets/img/visa.png" alt="">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="dropdown d-inline-block">
                                <a class="text-secondary dd-arrow-none" data-bs-toggle="dropdown" aria-expanded="false"
    ...
    <div class="row">
        <div class="col-12 col-md-6 col-lg-6 col-xxl-4 mb-4 ">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col ps-0 align-self-center">
                                        ...
                                        <p class="small text-secondary">Targeted <span class="float-end">$ 11600</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xxl-4 mb-4 ">
            <div class="card border-0  h-100">
                ...
                <div class="card-body">
                    <h4>2,545.98 <small>USD <small class="text-green"><i class="bi bi-arrow-up"></i> 108.71
                                (0.73%)</small></small></h4>
    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-6 col-xxl-4 mb-4 ">
            <div class="card border-0 h-100 overflow-hidden">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <i class="bi bi-receipt h5 avatar avatar-40 bg-light-blue text-blue rounded"></i>
                        </div>
                        <div class="col">
        ...
        <!-- event and offer -->
        <div class="col-12 col-md-12 col-lg-6 col-xxl-4 mb-4 ">
            <div class="card border-0 mb-4">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col-auto">
    ...
    <div class="row">
        ...
        <div class="col-12 col-xxl-2 ">
            <div class="row">
                <div class="col-6 col-sm-6 col-md-6 col-xxl-12">
                    <div class="card border-0 bg-green text-white mb-4">
                        ...
                        <div class="card-body bg-none">
                            ...
                            <p class="small text-muted">16 transactions</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-md-6 col-xxl-12">
                    <div class="card border-0 mb-4">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <i class="bi bi-currency-bitcoin h4 me-1 avatar avatar-40 bg-light-theme rounded me-2"></i>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            ...
                            <p class="small text-muted mb-0">8 Crypto</p>
                            <p class="small text-muted mb-4">5 New</p>
                    ...
                    <div class="row gx-0 h-100">
                        <div class="col-12 col-lg-12 col-xl-8 col-xxl-7">
                            ...
                            <div class="row align-items-center mx-0 ">
                                ...
                                <div class="col-12 py-2" id="footable-pagination"></div>
                            </div>
                        </div>
                        <div class="col-12 col-lg-12 col-xl-4 col-xxl-5 bg-light-theme">
                            <div class="row h-100 mx-0">
                                ...
                                <div class="col-12 bg-light-white mt-auto py-3 position-relative">
...
<div class="container-fluid mb-4">
    <div class="container footer-page bg-radial-gradient-theme mt-4 py-4">
        <div class="row mb-3">
            <div class="col-12 col-xl-11 mx-auto">
                <div class="row">
                    <div class="col-12 col-xxl-4 mb-xxl-0 mb-3">
                        <h4 class="mb-3"><span class="text-gradient">#1 Creative</span> &<br/><span
                                    class="text-gradient">Multipurpose</span> HTML Template</h4>
                        <h5>Clean & Trending UI design with<br/>a great user experience</h5>
                        <p>AdminUX is creative and multipurpose template.</p>
                    </div>
                    <div class="col-6 col-sm-6 col-md-4 col-xxl-2 ms-xxl-auto mb-5 mb-md-0">
                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-xxl-2 mb-5 mb-md-0">
                        ...
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link px-0" href="AdminUX/app-pricing.html" target="_blank">Buy Now <i
                        ...
                        <a class="navbar-brand d-block mb-3" href="#">
                            <div class="row">
                                ...
                                <div class="col ps-0 align-self-center">
                                    ...
                                    <p class="text-muted">Mobile Dashboard UI</p>
                                </div>
                            </div>
                        </a>
                        ...
                        <ul class="nav justify-content-center">
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">
                                    <i class="bi bi-microsoft h4 d-block mb-3"></i>
                                    <p class="mb-0 small">Microsoft</p>
                                    <p>Store</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">
                                    <i class="bi bi-play-fill h3 d-block mb-3"></i>
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-center" href="#">
                                    <i class="bi bi-apple h4 d-block mb-3"></i>
                                    <p class="mb-0 small">Download on</p>
                                    <p>App Store</p>
                                </a>
                            </li>
                        </ul>
