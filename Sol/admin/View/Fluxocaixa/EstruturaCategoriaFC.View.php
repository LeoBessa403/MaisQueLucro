<div class="modal fade" id="estruturaCategoriaFC" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered ">
        <div class="modal-content bg-color-purple">
            <div class="modal-header d-block">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <h6 class="fw-medium mb-0">Estrutura de Categoria de Fluxo de Caixa</h6>
                    </div>
                    <div class="col-auto">
