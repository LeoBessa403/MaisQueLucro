...
window.ProductTourJS = {
    ...
    htmlInit: function ($wrapper) {
        ...
        $.each(this.tips, function (index, tip) {
            html += "<div class='product-tour-js-single-step js-product-tour-index-" + index + "'><span class='product-tour-js-pulse'></span><div class='product-tour-js-single-step-inner is-" + tip.position + "'><div class='product-tour-js-progress'><span class='product-tour-js-progress-inner' style='width: " + Math.round((index + 1) / self.totalSteps * 100) + "%'></span></div><div class='product-tour-js-image coverimg' style='background-image: url(" + tip.image + ")'></div><div class='product-tour-js-title'>" + tip.title + "</div><div class='product-tour-js-description'>" + tip.description + "</div>" + (tip.additionalHtml || "") + "</div></div>"
        });
