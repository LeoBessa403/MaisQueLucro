...
$(window).on('load', function () {
    ...
    gradientgreen.addColorStop(0, 'rgba(46, 156, 101, 0.85)');
    ...
    var areachart1 = areachart.createLinearGradient(0, 0, 0, 145);
    areachart1.addColorStop(0, 'rgba(1, 94, 194, 0.4)');
    areachart1.addColorStop(1, 'rgba(0, 197, 221, 0)');
    var areachart2 = areachart.createLinearGradient(0, 0, 0, 140);
    areachart2.addColorStop(0, 'rgba(240, 61, 79, 0.4)');
    areachart2.addColorStop(1, 'rgba(255, 223, 220, 0)');
    var areachart3 = areachart.createLinearGradient(0, 0, 0, 145);
    areachart3.addColorStop(0, 'rgba(46, 156, 101, 0.85)');
    areachart3.addColorStop(1, 'rgba(176, 197, 0, 0)');
    var myareachart = {
        type: 'bar',
        data: {
            labels: ['Jan-15', 'Jan-30', 'Feb-15', 'Feb-30', 'Mar-15', 'Mar-30', 'Apr-15', 'Apr-30'],
            datasets: [{
                label: '# income',
                data: [
                    randomScalingFactor(),
        ...
        datasets: [
            {
                ...
                data: [40, 10, 15, 25, 10],
                backgroundColor: ['#ffbb00', '#2e9c65', '#ff6f6a', '#015ec2', '#becede'],
                borderWidth: 0,
            }
        ]
    };
