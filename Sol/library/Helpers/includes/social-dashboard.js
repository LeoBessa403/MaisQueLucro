...
$(window).on('load', function () {
    ...
    var gradientgreen = areachartgreen.createLinearGradient(0, 0, 0, 85);
    ...
    gradientmediumgreen.addColorStop(0, 'rgba(46, 156, 101, 0.85)');
    ...
    var barchartblue = document.getElementById('barchartblue').getContext('2d');
    var mybarchartCofig = {
        type: 'bar',
        data: {
    ...
    var myBarChartblue = new Chart(barchartblue, mybarchartCofig);
    /* my area chart randomize */
    setInterval(function () {
