            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        $arrColunas = array('Página', 'Nº de Visitas', 'Nº de Usuários', 'Ações');
                        $grid->setColunasIndeces($arrColunas);
                        $grid->criaGrid();
                        $i = 0;
                        foreach ($visitasPagina as $visitaPagina):
                            $acao = ' <a href="' . PASTAADMIN . 'Visita/DetalharVisitas/' .
                                Valida::GeraParametro(CO_PAGINA . "/" . $visitaPagina[CO_PAGINA]) . '" 
                                class="btn btn-green tooltips" 
                                    data-original-title="Detalhes das Visitas" data-placement="top">
