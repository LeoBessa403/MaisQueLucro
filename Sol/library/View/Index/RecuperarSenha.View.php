...
?>
    ...
    <div class="col-12 align-self-center">
        <div class="row align-items-center justify-content-center">
            <div class="col-12 col-sm-8 cx-login col-md-6 col-lg-5 col-xl-4 col-xxl-3 text-center text-white">
                <h3 class="mb-3 mb-lg-4">Recuperar Senha</h3>
                <p class="mb-4">Por Favor! Entre com o E-Mail para recuperar sua senha.
                ...
                <ul class="nav justify-content-center">
                    <li class="nav-item"><a class="nav-link px-2" href=""><img src="<?= PASTAIMG; ?>facebook.png"
                                                                               alt=""/></a></li>
                    <li class="nav-item"><a class="nav-link px-2" href=""><img src="<?= PASTAIMG; ?>google.png" alt=""/></a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="col-12 col-sm-8 col-md-6 col-lg-5 col-xl-4 col-xxl-3 mt-auto mb-4 text-center d-grid">
        ...
        <p class="text-white"><a href="<?= PASTAADMIN; ?>Index/Acessar"
                                 class="btn btn-mini cx-login btn-theme z-index-5 mb-4"> Voltar </a></p>
    </div>
